...
// For /fpga_pins/fpga|timer$binputs.
logic [3:0] FpgaPins_Fpga_TIMER_binputs_a0,
            FpgaPins_Fpga_TIMER_binputs_a1;
...
// For /fpga_pins/fpga|timer$cnt3.
logic [31:0] FpgaPins_Fpga_TIMER_cnt3_a1,
             FpgaPins_Fpga_TIMER_cnt3_a2;
...
logic [0:0] FpgaPins_Fpga_TIMER_dsel_a1,
            FpgaPins_Fpga_TIMER_dsel_a2;

// For /fpga_pins/fpga|timer$hexout.
logic [6:0] FpgaPins_Fpga_TIMER_hexout_a1;

// For /fpga_pins/fpga|timer$out0.
logic [3:0] FpgaPins_Fpga_TIMER_out0_a0;

// For /fpga_pins/fpga|timer$out1.
logic [3:0] FpgaPins_Fpga_TIMER_out1_a0;

// For /fpga_pins/fpga|timer$pause.
logic [0:0] FpgaPins_Fpga_TIMER_pause_a1;
...
// For /fpga_pins/fpga|timer$resume.
logic [0:0] FpgaPins_Fpga_TIMER_resume_a1;

// For /fpga_pins/fpga|timer$rreset.
logic [0:0] FpgaPins_Fpga_TIMER_rreset_a1;

// For /fpga_pins/fpga|timer$start.
logic [0:0] FpgaPins_Fpga_TIMER_start_a1;
   ...
   //
      ...
      //
         ...
         //
            ...
            // Staging of $binputs.
            always_ff @(posedge clk) FpgaPins_Fpga_TIMER_binputs_a1[3:0] <= FpgaPins_Fpga_TIMER_binputs_a0[3:0];
            ...
            // Staging of $cnt3.
            always_ff @(posedge clk) FpgaPins_Fpga_TIMER_cnt3_a2[31:0] <= FpgaPins_Fpga_TIMER_cnt3_a1[31:0];

            // Staging of $dsel.
            always_ff @(posedge clk) FpgaPins_Fpga_TIMER_dsel_a2[0:0] <= FpgaPins_Fpga_TIMER_dsel_a1[0:0];
   ...
   if (1) begin : DEBUG_SIGS_GTKWAVE
      ...
      if (1) begin : \/fpga_pins 
         ...
         if (1) begin : \/fpga 
            ...
            //
            if (1) begin : P_timer
               (* keep *) logic [3:0] \///@0$binputs ;
               assign \///@0$binputs = FpgaPins_Fpga_TIMER_binputs_a0;
               (* keep *) logic  \///@0$clk ;
               ...
               (* keep *) logic [31:0] \///@1$cnt3 ;
               assign \///@1$cnt3 = FpgaPins_Fpga_TIMER_cnt3_a1;
               ...
               (* keep *) logic [3:0] \///@0$out0 ;
               assign \///@0$out0 = FpgaPins_Fpga_TIMER_out0_a0;
               (* keep *) logic [3:0] \///@0$out1 ;
               assign \///@0$out1 = FpgaPins_Fpga_TIMER_out1_a0;
               (* keep *) logic [0:0] \///@1$pause ;
               assign \///@1$pause = FpgaPins_Fpga_TIMER_pause_a1;
               (* keep *) logic  \///@1$pulse ;
               assign \///@1$pulse = FpgaPins_Fpga_TIMER_pulse_a1;
               (* keep *) logic  \///@0$reset ;
               assign \///@0$reset = FpgaPins_Fpga_TIMER_reset_a0;
               (* keep *) logic [0:0] \///@1$resume ;
               assign \///@1$resume = FpgaPins_Fpga_TIMER_resume_a1;
               (* keep *) logic [0:0] \///@1$rreset ;
               assign \///@1$rreset = FpgaPins_Fpga_TIMER_rreset_a1;
               (* keep *) logic [0:0] \///@1$start ;
               assign \///@1$start = FpgaPins_Fpga_TIMER_start_a1;
            end
         end
      end
         ...
         //_/fpga
            //_\source top.tlv 48   // Instantiated from /raw.githubusercontent.com/osfpga/VirtualFPGALab/a069f1e4e19adc829b53237b3e0b5d6763dc3194/tlvlib/fpgaincludes.tlv, 340 as: m4+my_design.
               ...
               //_|timer
                  ...
                  //_@0
                     // Board inputs
                     assign FpgaPins_Fpga_TIMER_binputs_a0[3:0] = ui_in[3:0];
                     assign FpgaPins_Fpga_TIMER_out0_a0[3:0] = 4'h0; //4'h1;
                     assign FpgaPins_Fpga_TIMER_out1_a0[3:0] = 4'h0;
                  ...
                  //_@1
                     ...
                     // decode inputs
                     assign FpgaPins_Fpga_TIMER_rreset_a1[0:0] = FpgaPins_Fpga_TIMER_binputs_a1[0:0];
                     assign FpgaPins_Fpga_TIMER_start_a1[0:0] = FpgaPins_Fpga_TIMER_binputs_a1[1:1];
                     assign FpgaPins_Fpga_TIMER_pause_a1[0:0] = FpgaPins_Fpga_TIMER_binputs_a1[2:2];
                     assign FpgaPins_Fpga_TIMER_resume_a1[0:0] = FpgaPins_Fpga_TIMER_binputs_a1[3:3];
                     ...
                     assign FpgaPins_Fpga_TIMER_cnt2_a1[7:0] = FpgaPins_Fpga_TIMER_reset_a1 == 1'b1 ? 8'b0 :
                                  ...
                                  FpgaPins_Fpga_TIMER_cnt2_a1[7:0];
                     ...
                     assign FpgaPins_Fpga_TIMER_pulse_a1 = FpgaPins_Fpga_TIMER_reset_a1 == 1'b1 ? 1'b0 :
                              ...
                              FpgaPins_Fpga_TIMER_pulse_a1;
            
                     //10 millisecond counter
                     assign FpgaPins_Fpga_TIMER_cnt3_a1[31:0] = FpgaPins_Fpga_TIMER_reset_a1 == 1'b1 ? 32'b0 :
                                   FpgaPins_Fpga_TIMER_cnt3_a1[31:0] == 32'h00030d40 ? 32'b0 :
                                   FpgaPins_Fpga_TIMER_cnt3_a2[31:0] + 1;
                     ...
                     // this works
                     assign FpgaPins_Fpga_TIMER_dsel_a1[0:0] = FpgaPins_Fpga_TIMER_reset_a1 == 1'b1 ? 1'b0 :
                                  //$cnt1[7:0] == 8'hff ? ! >>1$dsel : // works
                                  //$cnt3[7:0] == 8'hff ? ! >>1$dsel : // works
                                  FpgaPins_Fpga_TIMER_cnt3_a1[31:0] == 8'hff ? ! FpgaPins_Fpga_TIMER_dsel_a2 :
                                  FpgaPins_Fpga_TIMER_dsel_a1[0:0];
